          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              <div className="text-center p-6 bg-blue-50 rounded-lg">
                <h4 className="text-xl font-bold text-blue-900">{selectedEventName}</h4>
                <p className="text-blue-700 mt-2">Selected Event</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            {locationDistribution.length > 1 ? (
              ...
              <div className="text-center p-8 text-gray-500">
                <p>All tickets from one location</p>
                {locationDistribution[0] && (
                  <p className="mt-2 text-lg font-semibold">{locationDistribution[0].location}</p>
                )}
              </div>
            )}
          </div>
